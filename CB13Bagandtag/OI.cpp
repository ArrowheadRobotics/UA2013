...
=======
#include "Commands/ClimberRelease.h"
>>>>>>> hey:CB13Bagandtag/OI.cpp
...
OI::OI() {
	...
	WinchInButton = new JoystickButton(gamepad, 9);
	WinchInButton->WhileHeld(new climberMove());
	WinchOutButton = new JoystickButton(gamepad, 10);
	WinchOutButton->WhileHeld(new ClimberRelease());
